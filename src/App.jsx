...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      {/* ─── FOOTER ─── */}
      <footer className="bg-gray-900 text-gray-400 py-12 pb-24 md:pb-12 relative overflow-hidden">
      ...
      <AnimatePresence>
        {showScrollTop && (
          <motion.button
            ...
            onClick={scrollToTop}
            className="fixed bottom-6 right-24 hidden md:flex w-12 h-12 bg-white border border-gray-200 rounded-full items-center justify-center shadow-lg hover:shadow-xl transition-shadow z-40 cursor-pointer"
